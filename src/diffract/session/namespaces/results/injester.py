...
class FieldIngester:
    ...
    def ingest(
        ...
        *,
        ...
        Raises:
            FieldIngestionError: If unknown uids or conflicts are detected.
        """
        ...
        conflicts = self._validate_fields(fields_by_uid, resolved, force)
    ...
    def _validate_fields(
        ...
        """Validate fields for conflict issues."""
